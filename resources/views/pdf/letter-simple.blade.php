{{-- Design Simple — Logo centré, pas de couleur, pas de style --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .header { position: fixed; top: -30mm; left: 0; right: 0; height: 28mm; text-align: center; padding-bottom: 3px; }
        .header img { display: block; margin: 0 auto; height: 65px; }
        .header .company-name { font-size: 8px; font-weight: bold; letter-spacing: 3px; color: #1a1a1a; margin-top: 3px; text-transform: uppercase; }

        .footer { position: fixed; bottom: -20mm; left: 0; right: 0; height: 14mm; text-align: center; font-size: 6.5px; color: #999; padding-top: 4px; line-height: 1.6; }
